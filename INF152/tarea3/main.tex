...
\begin{enumerate}
    ...
    Entonces, al crear un grafo con los datos de la tabla anterior, obtenemos:
        ...
        Como podemos ver, la holgura de la actividad J es $(290+\mu)-290-\mu$, por lo tanto, \textbf{independiente del 
        valor de $\mu$, J siempre pertenecerá a la ruta crítica}. La ruta crítica está conformada por las actividades 
